import type { Collection, Product, ProductType, ProductVariant } from "@/types/product";

export type { Collection, Product, ProductType, ProductVariant };
...
export const collections: Collection[] = [
  ...
  { slug: "prints", type: "print", label: { pt: "Prints", en: "Prints", es: "Prints" } },
];
